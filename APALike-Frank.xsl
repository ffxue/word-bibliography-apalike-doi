...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt"	xmlns:b="http://schemas.openxmlformats.org/officeDocument/2006/bibliography" xmlns:t="http://www.microsoft.com/temp">
  ...
  <xsl:template name="templ_prop_APA_CLS_CitationLong_FML" >
    <xsl:param name="LCID" />
  ...
  <xsl:template name="templ_prop_APA_CLS_CitationLong_FM" >
    <xsl:param name="LCID" />
    <xsl:variable name="_LCID">
      <xsl:call-template name="localLCID">
        <xsl:with-param name="LCID" select="$LCID"/>
  ...
  <xsl:template name="templ_prop_APA_CLS_CitationLong_ML" >
    <xsl:param name="LCID" />
    <xsl:variable name="_LCID">
      <xsl:call-template name="localLCID">
        <xsl:with-param name="LCID" select="$LCID"/>
  ...
  <xsl:template name="templ_prop_APA_CLS_CitationLong_FL" >
    <xsl:param name="LCID" />
    <xsl:variable name="_LCID">
      <xsl:call-template name="localLCID">
        <xsl:with-param name="LCID" select="$LCID"/>
  ...
  <xsl:template name="templ_prop_APA_CLS_CitationShort_FML" >
    <xsl:param name="LCID" />
    <xsl:variable name="_LCID">
      <xsl:call-template name="localLCID">
        <xsl:with-param name="LCID" select="$LCID"/>
  ...
  <xsl:template name="templ_prop_APA_CLS_CitationShort_FM" >
    <xsl:param name="LCID" />
    <xsl:variable name="_LCID">
      <xsl:call-template name="localLCID">
        <xsl:with-param name="LCID" select="$LCID"/>
  ...
  <xsl:template name="templ_prop_APA_CLS_CitationShort_ML" >
    <xsl:param name="LCID" />
    <xsl:variable name="_LCID">
      <xsl:call-template name="localLCID">
        <xsl:with-param name="LCID" select="$LCID"/>
  ...
  <xsl:template name="templ_prop_APA_CLS_CitationShort_FL" >
    <xsl:param name="LCID" />
    <xsl:variable name="_LCID">
      <xsl:call-template name="localLCID">
        <xsl:with-param name="LCID" select="$LCID"/>
  ...
  <xsl:template name="templ_prop_APA_CLS_MainAuthors_FML" >
    <xsl:param name="LCID" />
    <xsl:variable name="_LCID">
      <xsl:call-template name="localLCID">
        <xsl:with-param name="LCID" select="$LCID"/>
  ...
  <xsl:template name="templ_prop_APA_CLS_MainAuthors_FM" >
    <xsl:param name="LCID" />
    <xsl:variable name="_LCID">
      <xsl:call-template name="localLCID">
        <xsl:with-param name="LCID" select="$LCID"/>
  ...
  <xsl:template name="templ_prop_APA_CLS_MainAuthors_ML" >
    <xsl:param name="LCID" />
    <xsl:variable name="_LCID">
      <xsl:call-template name="localLCID">
        <xsl:with-param name="LCID" select="$LCID"/>
  ...
  <xsl:template name="templ_prop_APA_CLS_MainAuthors_FL" >
    <xsl:param name="LCID" />
    <xsl:variable name="_LCID">
      <xsl:call-template name="localLCID">
        <xsl:with-param name="LCID" select="$LCID"/>
  ...
  <xsl:template name="templ_prop_APA_CLS_SecondaryAuthors_FML" >
    <xsl:param name="LCID" />
    <xsl:variable name="_LCID">
      <xsl:call-template name="localLCID">
        <xsl:with-param name="LCID" select="$LCID"/>
  ...
  <xsl:template name="templ_prop_APA_CLS_SecondaryAuthors_FM" >
    <xsl:param name="LCID" />
    <xsl:variable name="_LCID">
      <xsl:call-template name="localLCID">
        <xsl:with-param name="LCID" select="$LCID"/>
  ...
  <xsl:template name="templ_prop_APA_CLS_SecondaryAuthors_ML" >
    <xsl:param name="LCID" />
    <xsl:variable name="_LCID">
      <xsl:call-template name="localLCID">
        <xsl:with-param name="LCID" select="$LCID"/>
  ...
  <xsl:template name="templ_prop_APA_CLS_SecondaryAuthors_FL" >
    <xsl:param name="LCID" />
    <xsl:variable name="_LCID">
      <xsl:call-template name="localLCID">
        <xsl:with-param name="LCID" select="$LCID"/>
  ...
  <xsl:template name="templ_prop_APA_CLS_BeforeLastAuthor" >
    <xsl:param name="LCID" />
    <xsl:variable name="_LCID">
      <xsl:call-template name="localLCID">
        <xsl:with-param name="LCID" select="$LCID"/>
  ...
  <xsl:template name="templ_prop_APA_CLS_GeneralOpen" >
    <xsl:param name="LCID" />
    <xsl:variable name="_LCID">
      <xsl:call-template name="localLCID">
        <xsl:with-param name="LCID" select="$LCID"/>
  ...
  <xsl:template name="templ_prop_APA_CLS_GeneralClose" >
    <xsl:param name="LCID" />
    <xsl:variable name="_LCID">
      <xsl:call-template name="localLCID">
        <xsl:with-param name="LCID" select="$LCID"/>
  ...
  <xsl:template name="templ_prop_APA_CLS_SecondaryOpen" >
    <xsl:param name="LCID" />
    <xsl:variable name="_LCID">
      <xsl:call-template name="localLCID">
        <xsl:with-param name="LCID" select="$LCID"/>
  ...
  <xsl:template name="templ_prop_APA_CLS_SecondaryClose" >
    <xsl:param name="LCID" />
    <xsl:variable name="_LCID">
      <xsl:call-template name="localLCID">
        <xsl:with-param name="LCID" select="$LCID"/>
  ...
  <xsl:template name="templ_prop_APA_CLS_Date_DMY" >
    <xsl:param name="LCID" />
    <xsl:variable name="_LCID">
      <xsl:call-template name="localLCID">
        <xsl:with-param name="LCID" select="$LCID"/>
  ...
  <xsl:template name="templ_prop_APA_CLS_Date_DM" >
    <xsl:param name="LCID" />
    <xsl:variable name="_LCID">
      <xsl:call-template name="localLCID">
        <xsl:with-param name="LCID" select="$LCID"/>
  ...
  <xsl:template name="templ_prop_APA_CLS_Date_MY" >
    <xsl:param name="LCID" />
    <xsl:variable name="_LCID">
      <xsl:call-template name="localLCID">
        <xsl:with-param name="LCID" select="$LCID"/>
  ...
  <xsl:template name="templ_prop_APA_CLS_Date_DY" >
    <xsl:param name="LCID" />
    <xsl:variable name="_LCID">
      <xsl:call-template name="localLCID">
        <xsl:with-param name="LCID" select="$LCID"/>
  ...
  <xsl:template name="templ_prop_APA_CLS_DateAccessed_DMY" >
    <xsl:param name="LCID" />
    <xsl:variable name="_LCID">
      <xsl:call-template name="localLCID">
        <xsl:with-param name="LCID" select="$LCID"/>
  ...
  <xsl:template name="templ_prop_APA_CLS_DateAccessed_DM" >
    <xsl:param name="LCID" />
    <xsl:variable name="_LCID">
      <xsl:call-template name="localLCID">
        <xsl:with-param name="LCID" select="$LCID"/>
  ...
  <xsl:template name="templ_prop_APA_CLS_DateAccessed_MY" >
    <xsl:param name="LCID" />
    <xsl:variable name="_LCID">
      <xsl:call-template name="localLCID">
        <xsl:with-param name="LCID" select="$LCID"/>
  ...
  <xsl:template name="templ_prop_APA_CLS_DateAccessed_DY" >
    <xsl:param name="LCID" />
    <xsl:variable name="_LCID">
      <xsl:call-template name="localLCID">
        <xsl:with-param name="LCID" select="$LCID"/>
  ...
  <xsl:template name="templ_prop_APA_CLS_DateCourt_DMY" >
    <xsl:param name="LCID" />
    <xsl:variable name="_LCID">
      <xsl:call-template name="localLCID">
        <xsl:with-param name="LCID" select="$LCID"/>
  ...
  <xsl:template name="templ_prop_APA_CLS_DateCourt_DM" >
    <xsl:param name="LCID" />
    <xsl:variable name="_LCID">
      <xsl:call-template name="localLCID">
        <xsl:with-param name="LCID" select="$LCID"/>
  ...
  <xsl:template name="templ_prop_APA_CLS_DateCourt_MY" >
    <xsl:param name="LCID" />
    <xsl:variable name="_LCID">
      <xsl:call-template name="localLCID">
        <xsl:with-param name="LCID" select="$LCID"/>
  ...
  <xsl:template name="templ_prop_APA_CLS_DateCourt_DY" >
    <xsl:param name="LCID" />
    <xsl:variable name="_LCID">
      <xsl:call-template name="localLCID">
        <xsl:with-param name="LCID" select="$LCID"/>
  ...
  <xsl:template match="/">
    ...
    <xsl:choose>
      ...
      <xsl:when test="b:Version">
        <xsl:text>2023.1.1</xsl:text>
      </xsl:when>

      <xsl:when test="b:OfficeStyleKey">
        <xsl:text>APALike-DOI</xsl:text>
      </xsl:when>
									...
									<xsl:for-each select="msxsl:node-set($ListPopulatedWithMain)/b:Citation/b:Source/b:Author/b:Main/b:NameList/b:Person">
										<xsl:if test="position() = 1">
											<xsl:call-template name="formatNameCore">
												<xsl:with-param name="FML"><xsl:call-template name="templ_prop_APA_CLS_CitationShort_FML"/></xsl:with-param>
												<xsl:with-param name="FM"><xsl:call-template name="templ_prop_APA_CLS_CitationShort_FM"/></xsl:with-param>
												<xsl:with-param name="ML"><xsl:call-template name="templ_prop_APA_CLS_CitationShort_ML"/></xsl:with-param>
												<xsl:with-param name="FL"><xsl:call-template name="templ_prop_APA_CLS_CitationShort_FL"/></xsl:with-param>
										...
										<xsl:if test="$cAuthors &lt;= $maxCitationAuthors">
											<xsl:if test="position() = $cAuthors - 1">
												<xsl:if test="$cAuthors = 2">
													<xsl:call-template name="templ_prop_Space"/>
													<xsl:call-template name="templ_prop_APA_CLS_BeforeLastAuthor"/>
													<xsl:call-template name="templ_prop_Space"/>
												</xsl:if>
          ...
          <body>
            ...
            <xsl:for-each select="msxsl:node-set($sList)/b:Bibliography/b:Source">
              ...
              <xsl:element name="p">
                ...
                <xsl:variable name="arxivPrefix" select="'arxiv:'"/>
                ...
                <xsl:variable name="i_titleEditionVolumeDot">
                  <xsl:if test="string-length($title)>0">
                    ...
                    <xsl:if test="string-length($edition)>0 or string-length($prefixVolumeCap)>0">
                      <xsl:call-template name="templ_prop_Space"/>
                      <xsl:call-template name="templ_prop_APA_CLS_GeneralOpen"/>
                      ...
                      <xsl:call-template name="templ_prop_APA_CLS_GeneralClose"/>
                      <xsl:call-template name="templ_prop_Dot"/>
                    </xsl:if>
                  </xsl:if>
                </xsl:variable>
                ...
                <xsl:variable name="thePerformerAndConductorDot">
                  <xsl:if test="string-length($SecondarySoundRecordingName)>0">
                    <xsl:call-template name="templ_prop_APA_CLS_SecondaryOpen"/>
                    ...
                    <xsl:call-template name="templ_prop_APA_CLS_SecondaryClose"/>
                    <xsl:call-template name="templ_prop_Dot"/>
                  </xsl:if>
                </xsl:variable>
                ...
                <xsl:choose>
                  ...
                  <xsl:when test="string-length($tempRDAFU)>0">
                    <xsl:choose>
                      <xsl:when test="string-length(b:URL)>0 and contains($tempRDAFU, b:URL)">
                        <xsl:value-of select="substring-before($tempRDAFU, b:URL)" />
                        <xsl:element name="a">
                          <xsl:attribute name="href">
                  ...
                  <!-- arxiv -->
                  <xsl:when test="string-length($pages)>6 and contains(translate($pages, $uppercase, $lowercase), $arxivPrefix)">
                    <xsl:text> </xsl:text>
                    <xsl:element name="a">
                      <xsl:attribute name="href">
                        <xsl:text>https://arxiv.org/abs/</xsl:text>
                        <xsl:value-of select="substring-after(translate($pages, $uppercase, $lowercase), $arxivPrefix)" />
                      </xsl:attribute>
                      <xsl:text>https://arxiv.org/abs/</xsl:text>
                      <xsl:value-of select="substring-after(translate($pages, $uppercase, $lowercase), $arxivPrefix)" />
                    </xsl:element>
  ...
  <xsl:template name="formatDate">
    ...
    <xsl:call-template name="formatDateCore">
      ...
      <xsl:with-param name="DMY">
        <xsl:call-template name="templ_prop_APA_CLS_Date_DMY"/>
      </xsl:with-param>
      <xsl:with-param name="DM">
        <xsl:call-template name="templ_prop_APA_CLS_Date_DM"/>
      </xsl:with-param>
      <xsl:with-param name="MY">
        <xsl:call-template name="templ_prop_APA_CLS_Date_MY"/>
      </xsl:with-param>
      <xsl:with-param name="DY">
        <xsl:call-template name="templ_prop_APA_CLS_Date_DY"/>
      </xsl:with-param>
  ...
  <xsl:template name="formatDateAccessed">
    <xsl:call-template name="formatDateCore">
      ...
      <xsl:with-param name="DMY">
        <xsl:call-template name="templ_prop_APA_CLS_DateAccessed_DMY"/>
      </xsl:with-param>
      <xsl:with-param name="DM">
        <xsl:call-template name="templ_prop_APA_CLS_DateAccessed_DM"/>
      </xsl:with-param>
      <xsl:with-param name="MY">
        <xsl:call-template name="templ_prop_APA_CLS_DateAccessed_MY"/>
      </xsl:with-param>
      <xsl:with-param name="DY">
        <xsl:call-template name="templ_prop_APA_CLS_DateAccessed_DY"/>
      </xsl:with-param>
  ...
  <xsl:template name="formatDateCourt">
    <xsl:call-template name="formatDateCore">
      ...
      <xsl:with-param name="DMY">
        <xsl:call-template name="templ_prop_APA_CLS_DateCourt_DMY"/>
      </xsl:with-param>
      <xsl:with-param name="DM">
        <xsl:call-template name="templ_prop_APA_CLS_DateCourt_DM"/>
      </xsl:with-param>
      <xsl:with-param name="MY">
        <xsl:call-template name="templ_prop_APA_CLS_DateCourt_MY"/>
      </xsl:with-param>
      <xsl:with-param name="DY">
        <xsl:call-template name="templ_prop_APA_CLS_DateCourt_DY"/>
      </xsl:with-param>
    </xsl:call-template>
  </xsl:template>
  ...
  <xsl:template name="formatMainAuthor">
    <xsl:call-template name="formatNameCore">
      <xsl:with-param name="FML">
        <xsl:call-template name="templ_prop_APA_CLS_MainAuthors_FML"/>
      </xsl:with-param>
      <xsl:with-param name="FM">
        <xsl:call-template name="templ_prop_APA_CLS_MainAuthors_FM"/>
      </xsl:with-param>
      <xsl:with-param name="ML">
        <xsl:call-template name="templ_prop_APA_CLS_MainAuthors_ML"/>
      </xsl:with-param>
      <xsl:with-param name="FL">
        <xsl:call-template name="templ_prop_APA_CLS_MainAuthors_FL"/>
      </xsl:with-param>
      <xsl:with-param name="upperLast">no</xsl:with-param>
  ...
  <xsl:template name="formatSecondaryName">
    <xsl:call-template name="formatNameCore">
      <xsl:with-param name="FML">
        <xsl:call-template name="templ_prop_APA_CLS_SecondaryAuthors_FML"/>
      </xsl:with-param>
      <xsl:with-param name="FM">
        <xsl:call-template name="templ_prop_APA_CLS_SecondaryAuthors_FM"/>
      </xsl:with-param>
      <xsl:with-param name="ML">
        <xsl:call-template name="templ_prop_APA_CLS_SecondaryAuthors_ML"/>
      </xsl:with-param>
      <xsl:with-param name="FL">
        <xsl:call-template name="templ_prop_APA_CLS_SecondaryAuthors_FL"/>
      </xsl:with-param>
      <xsl:with-param name="upperLast">no</xsl:with-param>
      <xsl:with-param name="withDot">yes</xsl:with-param>
    </xsl:call-template>
  ...
  <xsl:variable name="maxBibAuthors" select="37"/>
